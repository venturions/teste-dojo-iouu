...
export default function Lendings(props) {
    ...
    const popover = (rowData) => {
        ...
        rowData;
        return (
            <Popover style={{ minWidth: '300px' }} className="mt-1" id="popover-basic">
    ...
    const columns = [
            ...
            selector: (rowData) => {
                ...
                for (index = 0; index < props.lendings.length; index++) {
                    if (rowData.razaoSocial === props.lendings[index].razaoSocial) {
                        aux += props.lendings[index].valor;
                    }
                }
        ...
        },
        {
            ...
            cell: (rowData) => {
                return (
                    <OverlayTrigger trigger="click" placement="bottom" overlay={popover(rowData)}>
                        <CellButton
                            onClick={() => {
                                setTeste(
